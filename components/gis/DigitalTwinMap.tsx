...
export const DigitalTwinMap: React.FC<DigitalTwinMapProps> = ({
  ...
  return (
    <div className="relative w-full rounded-2xl border border-cyan-500/25 bg-[#050b18] overflow-hidden shadow-2xl">
      {/* Top Map Control Bar */}
      <div className="absolute top-4 left-4 right-4 z-20 flex flex-wrap items-center justify-between gap-3 bg-[rgba(3,7,18,0.85)] p-2.5 rounded-xl border border-slate-800 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 text-cyan-400 font-mono text-xs font-semibold">
            <Radio className="w-3.5 h-3.5 animate-pulse text-cyan-400" />
            <span>GIS TWIN CANVAS</span>
          </div>
